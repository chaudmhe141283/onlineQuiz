 ...
 * @author Admin
 */
@WebFilter(filterName = "Authenticator", urlPatterns = {""}, dispatcherTypes = {DispatcherType.REQUEST})
public class Authenticator implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("Authenticator:DoBeforeProcessing");
        }
...
//        boolean loginSession = ses != null && ses.getAttribute("user") != null;
//        String requestURL = req.getContextPath() + "/LoginForm.jsp";
//        if (loginSession) {
//            if (req.getRequestURI().equals(requestURL)) {
//                res.sendRedirect("TakeQuizStep1.jsp");
//            } else {
...
//        }
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("Authenticator::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("Authenticator::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("Authenticator::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("Authenticator::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("Authenticator::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
